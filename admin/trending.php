...
if (isset($_POST["submit"])) {
    ...
    $insertQuery="INSERT INTO `trending`(`name`, `image`, `description`, `price`,`trestatus`,`location`) 
    VALUES ('$name','$target_file','$description','$price','$status','$location')";
    if ($uploadOk == 0) {
    ...
    mysqli_rollback($con);
    echo "Sorry, there was an error try later.";
}
}
?>
<?php
