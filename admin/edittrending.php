    ...
    try {
        if(isset($_FILES['newImage']) && $_FILES['newImage']['error'] === UPLOAD_ERR_OK) {
            ...
            if(move_uploaded_file($newImage['tmp_name'], $imagePath)) {
                $query = "UPDATE trending SET name='$name', price='$price', location='$location', description='$description', image='$imagePath' WHERE trending_id='$id'";
            } else {
                throw new Exception("Failed to upload image.");
            }
        } else {
            $query = "UPDATE trending SET name='$name', price='$price', location='$location', description='$description' WHERE trending_id='$id'";
        }
