...
<head>
    ...
    <style>
        ...
        .navbar-title form button{
            ...
            padding: 8px;
            cursor: pointer;
            box-shadow: 0 3rem rgba(121,121,121,0.3rem);
        }
        .navbar-title form button:hover{
            filter: brightness(110%);
        }
        .navbar-title form button:active{
    ...
    <section class="navbaaaaaar">
        ...
        if(!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] != true) {
            ?>
                ...
                <ul class='right-ul'>
                    <li class="no">Tel Number : 123-4568790</li>
        ...
        <div class="navbar-title">
            ...
            <form action="" method="post">
                    ...
                    <button type="submit" class="searchbar" name="Searchbar">Search</button>
                </form>               
            <ul class="secondnav">
                <li><a href="main.php"><i class="fas fa-home"></i></a></li>
